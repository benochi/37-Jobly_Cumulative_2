...
//test findAll using the insert values from _testCommon.js
/*('Job1', 100, '0.1', 'c1'),
  ('Job2', 200, '0.2', 'c1'),
  ('Job3', 300, '0', 'c1'),
  ('Job4', NULL, NULL, 'c1') */
...
describe("findAll", function () {
  ...
  //should return only jobs over minimum. 
  ...
  //multiple variables test with minSalary and hasEquity
